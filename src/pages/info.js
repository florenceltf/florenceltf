...
export default function InfoPage() {
  return (
    <div className="Info">
      <div className="left">is a Melbourne-born communications designer taking time off to eat, drink and nap <a href="http://holidaze.florenceltf.com/">somewhere in the world</a>. Currently freelancing abroad with <a href="https://www.round.com.au">Studio Round</a>. 
      <br></br><br></br>
