...
function Content() {
  return (
    <div className="Content">
      <div className="left">is a Melbourne-born communications designer <a href="http://holidaze.florenceltf.com/">mostly travelling</a> and ocassionally working. Currently freelancing remotely with Melbourne-based studio, <a href="https://www.round.com.au">Round</a>. 
        <br></br><br></br>
